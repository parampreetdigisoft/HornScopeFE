...
export class PlansComponent {
  ...
  async makePayment() {
    ...
    this.toasterService.showInfo("Hornscope System is currently at the pilot stage. Login and subscription features are temporarily unavailable while we finalize our email and authentication system.");
    return
