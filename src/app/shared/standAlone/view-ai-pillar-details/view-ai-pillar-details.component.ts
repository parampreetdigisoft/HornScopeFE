...
const PILLAR_TEXT_FIELDS: AiEditableFieldConfig[] = [
  ...
  { key: 'temporalReliability', label: 'Temporal Reliability', type: 'textarea' },
  ...
  { key: 'dataOpacityRisk', label: 'Data Opacity Risk', type: 'textarea' },
  { key: 'redFlag', label: 'Red Flags', type: 'textarea' },
  { key: 'reliabilityAssessment', label: 'Reliability Assessment', type: 'textarea' },
